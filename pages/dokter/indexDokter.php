      ...
      <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="?page=data_jadwal" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="?page=periksapasien" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="?page=riwayat_pasien" class="nav-link">
        ...
        <div class="cart">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'GET') {
                if (isset($_GET['page'])) {
                    if ($_GET['page'] == 'tambah_jadwal') {
                        include __DIR__ . "/../../pages/jadwal_periksa/tambah_jadwal.php";
                    } elseif ($_GET['page'] == 'data_jadwal') {
                        include __DIR__ . "/../../pages/jadwal_periksa/data_jadwal.php"; //memanggil halaman tampil data jadwal perika
                    } elseif ($_GET['page'] == 'periksapasien') {
                        include __DIR__ . "/../../pages/dokter/periksapasien.php"; //memanggil halaman form periksa
                    } elseif ($_GET['page'] == 'riwayat_pasien') {
                        include __DIR__ . "/../../pages/riwayat_pasien/riwayat_pasien.php"; //memanggil halaman form periksa
                    }
                } else {
